...
import sp17 from '../../../images/sp-17.webp';
import sp18 from '../../../images/sp-18.webp';
import sp19 from '../../../images/sp-19.webp';
import sp20 from '../../../images/sp-20.webp';
...
const SalesData = [
    ...
    {
        image: sp18,
        title: "Giường Ngủ Gỗ Tràm MOHO MALAGA 302 Nhiều Kích Thước",
        price: "4,290,000₫",
        discount: "5,990,000₫",
        description: (
            <div>
                <p>Kích thước: </p>
                <ul>
                    <li>- Dài 200cm x Rộng 120cm/160cm/180cm</li>
                    <li>- Cao đến đầu giường 77cm</li>
                </ul>
                <p>Khoảng trống đầu giường cao 17cm</p>
                <p>Chất liệu:</p>
                <ul>
                    <li>- Thân giường: Gỗ tràm tự nhiên</li>
                    <li>- Thanh vạt/ Tấm phản: Gỗ plywood chuẩn CARB-P2 (*)</li>
                </ul>
                <p>(*) Tiêu chuẩn California Air Resources Board xuất khẩu Mỹ, đảm bảo gỗ không độc hại, an toàn cho sức khỏe</p>
                <p>Đây là sản phẩm Clearance, không áp dụng bảo hành và bảo trì.</p>
                <p>Sản phẩm chỉ còn hàng tại TP.HCM</p>
            </div>
        )
    },
    {
        image: sp19,
        title: "Ghế Ăn Gỗ Cao Su Tự Nhiên MOHO FYN",
        price: "1,590,000₫",
        discount: "2,190,000₫",
        description: (
            <div>
                <p>Kích thước: Dài 45cm x Rộng 50cm x Cao đến đệm ngồi/lưng tựa: 45cm/79cm</p>
                <p>Chất liệu: Gỗ cao su tự nhiên vải bọc chống thấm nước - chống nhăn, kháng bụi bẩn, nấm mốc</p>
                <p>Chống thấm, cong vênh, trầy xước, mối mọt</p>
            </div>
        )
    },
    {
        image: sp20,
        title: "Tủ Đầu Giường Gỗ MOHO VIENNA 201",
        price: "1,290,000₫",
        discount: "1,590,000₫",
        description: (
            <div>
                <p>Kích thước: Dài 48cm x Rộng 40cm x Cao 50cm</p>
                <p>Chất liệu: Gỗ công nghiệp PB chuẩn CARB-P2 (*), Sơn phủ UV</p>
                <p>(*) Tiêu chuẩn California Air Resources Board xuất khẩu Mỹ, đảm bảo gỗ không độc hại, an toàn cho sức khỏe</p>
            </div>
        )
